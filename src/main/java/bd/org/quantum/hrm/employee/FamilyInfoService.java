...
public class FamilyInfoService {
    ...
    public FamilyInfoService(FamilyInfoRepository repository,
    ...
    public ChangeHistory saveFamilyInfoChangeHistory(EmployeeFamilyInfoChangeHistoryDto object) {
        if (object != null) {
            ...
            try {
                ...
                changeHistory.setClassName(FamilyInfo.class.getSimpleName());
    ...
    @Transactional
    public FamilyInfo create(FamilyInfo familyInfo) {
        EmployeeFamilyInfoChangeHistoryDto dto = new EmployeeFamilyInfoChangeHistoryDto(familyInfo);
        saveFamilyInfoChangeHistory(dto);
