...
public class ExperienceInfoService {
    private final ExperienceInfoRepository repository;
    private final ChangeHistoryRepository historyRepository;

    public ExperienceInfoService(ExperienceInfoRepository repository,
    ...
    public ChangeHistory saveWorkingExperienceInfoChangeHistory(EmployeeExperienceChangeHistoryDto object) {
        if (object != null) {
            ...
            try {
                ...
                changeHistory.setClassName(ExperienceInfo.class.getSimpleName());
    ...
    @Transactional
    public ExperienceInfo create(ExperienceInfo experienceInfo) {
        EmployeeExperienceChangeHistoryDto dto = new EmployeeExperienceChangeHistoryDto(experienceInfo);
        saveWorkingExperienceInfoChangeHistory(dto);
        return repository.save(experienceInfo);
    }
